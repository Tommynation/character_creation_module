...
def attack(char_name: str, char_class: str) -> str:
    """Attack function. Damage depends on char class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Defence function.
    Amount of blocked damage depends on char class.
    """
    if char_class == 'warrior':
    ...
    return (f'{char_name} не блокировл урон')


def special(char_name: str, char_class: str) -> str:
    """Activate special skill. Depends on char class."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Activate starst of training.
    Need to choose skill from previous functions.
    """
    if char_class == 'warrior':
